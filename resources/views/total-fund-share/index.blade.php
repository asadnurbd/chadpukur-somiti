											...
											<div class="col-sm-12 text-right">
												...
												<div class="col-sm-8">
													...
													<div class="form-group form-primary mb-0">
											            ...
											            <button  class="btn btn-primary"> <a href="" class="text-white">শেয়ার</a> </button>
					...
					<div class="card" id="printTable">
							<div class="card-body">
                                ...
                                <tbody>
                                 ...
                                 @foreach($share_found_infos as $rijab_fund)
                                    @if(isset($rijab_fund['শেয়ার']))
                                     <tr role="row" class="odd text-center">
                                        <td colspan="4">{{$rijab_fund['month']}}/{{$rijab_fund['year']}}</td>
                                        ...
                                        @endphp 
                                        <td colspan="3">@php echo $total_share; @endphp</td>
                                       
										
                                    </tr>

                                    @elseif(isset($rijab_fund['রিজার্ভ_শেয়ার']))
                                    <tr role="row" class="odd text-center">
                                           <td colspan="4">{{$rijab_fund['year']}}</td>   
                                             
                                            <td colspan="4"></td>   
                                            <td colspan="3"></td>
                                                                        
                                            <td colspan="3">{{$rijab_fund['রিজার্ভ_শেয়ার']}}</td>
                                            ...
                                            @php
                                            $total_share+=$rijab_fund['রিজার্ভ_শেয়ার'];
                                            @endphp 
                                            <td colspan="3">@php echo $total_share; @endphp</td>
