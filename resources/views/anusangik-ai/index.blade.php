            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header text-center">
                        ...
                        <p class="text-primary pt-2">আনুষঙ্গিক/রিজার্ভ রশিদ আয়</p>
                    </div>
                    <div class="card-body">
                              ...
                              <div class="col-sm-12 text-right">
                               ...
                               <div class="col-sm-3">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">রিজার্ভ ঋণ আদায়</label>
                               ...
                               <div class="col-sm-6">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label class="floating-label" for="Text">রিজার্ভ সুদ আদায়</label>
                                ...
                                <div class="col-sm-8 pt-4">
                                    <div class="input-group">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect04" name="khroch_type">
                                            ...
                                            <option value="">আনুষঙ্গিক_খরচের_নাম</option>
