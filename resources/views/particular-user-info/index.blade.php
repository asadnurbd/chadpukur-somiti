        ...
        <div class="row" id="printTable">
            ...
            <div class=" row">
                ...
                <div class="card-header">
                    <span>হিসাব নং:{{$user_info->সদস্য_নং}}</span> <br>
                    <span>নাম:{{$user_info->সদস্য_নাম_মি_মিসেস_মিস}}</span> <br> </ln>
                    <span>পিতা/স্বামীর নাম: {{$user_info->সদস্য_পিতা_স্বামীর_নাম}}</span><br>
                    <span>ঠিকানা: {{$user_info->সদস্য_বর্তমান_ঠিকানা}}</span><br>
                        ...
                        <div class="dt-responsive table-responsive">
                            ...
                            {!! csrf_field() !!}
                                ...
                                <thead>
                                    <tr>
                                        <th>
                                            নাম: {{$user_info->সদস্য_নাম_মি_মিসেস_মিস}} &nbsp;<br>
                                            সদস্য_নং: {{$user_info->সদস্য_নং}}&nbsp; <br>
                                            
                                        </th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-sort="ascending" aria-label="First name: activate to sort column descending" style="width: 277.953px;">
                                         তারিখ 
                                       </th>
                                       <!-- <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Last name: activate to sort column ascending" style="width: 406.656px;">
                                        সংগ্রহ/খরচের <br>তালিকায় -পৃষ্ঠা নং
                                       </th> -->
                                       <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 205.672px;">
                                       (<span>শেয়ার</span>) ফেরৎ 
                                       </th>
                                       <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="age: activate to sort column ascending" style="width: 105.938px;">
                                       (<span>শেয়ার</span>) জমা 
                                       </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="DOB: activate to sort column ascending" style="width: 173.609px;">
                                        (<span>শেয়ার</span>) সর্বমোট জামা
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="DOB: activate to sort column ascending" style="width: 173.609px;">
                                        শেয়ার মাস
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>সঞ্চয়</span>) উত্তোলন
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>সঞ্চয়</span>) জামা
                                        </th>
                                      
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>সঞ্চয়</span>) সর্বমোট জামা
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>সঞ্চয়</span>) প্রডাক্ট
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>বিশেষ সঞ্চয়</span>) উত্তোলন
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>বিশেষ সঞ্চয়</span>) জামা
                                        </th>
                                      
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>বিশেষ সঞ্চয়</span>)সর্বমোট জামা
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="footer-callback" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 154.172px;">
                                        (<span>বিশেষ সঞ্চয়</span>) প্রডাক্ট
                                        </th>
                                ...
                                @php
                                 ...
                                 @foreach($user_all_infos as $user_all_info)
                                   ...
                                   <tr role="row" class="odd text-center">
                                       <td></td>
                                       <td class="sorting_1">{{ Carbon\Carbon::parse($user_all_info['created_at'])->format('d/m/Y') }}</td>
                                        <!-- <td>{{ Carbon\Carbon::parse($user_all_info['created_at'])->format('Y') }}</td> -->
                                        <td></td>
                                        <td>@php echo $user_all_info['শেয়ার'];@endphp</td>
                                        @php
                                         $total_share+=$user_all_info['শেয়ার'];
                                         $share_month=$total_share/100;
                                        @endphp 
                                        <td>@php echo $total_share; @endphp</td>
                                        <td>@php echo (int)$share_month; @endphp</td>
                                        <td></td>
                                        <td>@php echo $user_all_info['সঞ্চয়'];@endphp</td>
                                        @php
                                         $total_Saving+=$user_all_info['সঞ্চয়'];
                                        @endphp 
                                        <td>@php echo $total_Saving; @endphp</td>
                                        <td></td>
                                        <td></td>
                                        <td>@php echo $user_all_info['বিশেষ_সঞ্চয়'];@endphp</td>
                                        @php
                                         $total_Special_Saving+=$user_all_info['বিশেষ_সঞ্চয়'];
                                        @endphp 
                                        <td>@php echo $total_Special_Saving; @endphp</td>
                                        <td></td>
                                        @php
                                         $total_rin-=$user_all_info['ঋণ_ফেরৎ'];
                                        @endphp 
                                        <td>@php echo $user_all_info['ঋণ_ফেরৎ'];@endphp</td>
                                        <td>@php @endphp</td>
                                        
                                        <td>@php echo $total_rin; @endphp</td>
                                        <td>@php echo $user_all_info['সুদ'];@endphp</td>
                                        <td>@php echo $user_all_info['জরিমানা'];@endphp</td>
                                    </tr>
                                   ...
                                   <tr role="row" class="odd  text-center">
                                       <td></td>
                                        ...
                                        <!-- <td>{{ Carbon\Carbon::parse($user_all_info['created_at'])->format('Y') }}</td> -->
                                        <td>
                                        @php echo $user_all_info['শেয়ার_ফেরত'];@endphp
                                        </td>
                                        <td></td>
                                        @php
                                        ...
                                        <td> @php echo $user_all_info['সঞ্চয়_উত্তোলন'];@endphp</td>
                                        ...
                                        <td>@php echo $total_Saving; @endphp</td>
                                        <td></td>
                                        <td>@php echo $user_all_info['বিশেষ_সঞ্চয়_উত্তোলন'];@endphp</td>
                                        <td></td>
                                        
                                        <td>@php echo $total_Special_Saving-=$user_all_info['বিশেষ_সঞ্চয়_উত্তোলন']; @endphp</td>
                                        <td></td>
                                        
                                        
                                        <td></td>
                                        <td>@php echo $user_all_info['ঋণ_প্রদান'];@endphp </td>
                                        @php
...
<script src="{{ asset('assets') }}/js/plugins/bekti-kothian.print.min.js"></script>
