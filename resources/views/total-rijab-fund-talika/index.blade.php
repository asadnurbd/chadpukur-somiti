			...
			<div class="navbar-content">
				<ul class="pc-navbar">
					...
					<li class="pc-item pc-hasmenu">
						...
						<a href="/total-rijab-fund-talika" class="pc-link"><span class="pc-micon"><i class="feather icon-layout"></i></span><span class="pc-mtext">রিজার্ভ ফান্ড তালিকা</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
						...
						<div class="dropdown-menu pc-h-dropdown pc-mega-dmenu">
							<div class="row no-gutters">
							 <div class="col">
										...
										@csrf
											...
											<div class="col-sm-12 text-right">
												...
												<div class="col-sm-8">
													...
													<label class=" text-primary" >রিজার্ভ ফান্ড  :</label>
													<div class="form-group form-primary mb-0">
												
											            <button  class="btn btn-primary"> <a href="/total-fund-share" class="text-white">শেয়ার</a> </button>
													    <button  class="btn btn-primary"> <a href="" class="text-white">সঞ্চয়</a> </button>
										            	<button class="btn btn-primary"> <a href="" class="text-white">বিশেষ সঞ্চয় উত্তোলন</a></button>
										            	<button  class="btn btn-primary"> <a href="" class="text-white">ঋণ </a>  </button>
								...
								<div class="col">
								   <div class="card-body">
										<form action="/total-rijab-fund-talika-year" method="post">
											@csrf
					...
					<div class="card" id="printTable">
							<div class="card-body">
											...
											<div class="col-sm-12 font-center">
												<table class="table table-responsive invoice-table table-borderless">
													<tbody>
														...
														<tr>
                                                         <td style="font-size:20px;">রিজার্ভ ফান্ড তালিকা</td>
														</tr>
                                ...
                                @php 
                                  $total_share=0;
                                  $total_sonchoi=0;
                                  $total_bises_sonchoi=0;
                                  $total_rin=0;
                                @endphp
                                <tbody>
                               
                                 @foreach($rijab_funds as $rijab_fund)
                                
                                     <tr role="row" class="odd text-center">
                            
                                        <td colspan="4">{{$rijab_fund->ব্যক্তির_নাম}}</td>   
                                        @php
                                        $total_share +=$rijab_fund->শেয়ার;
                                        @endphp                               
                                        <td colspan="3">{{$rijab_fund->শেয়ার}}</td>
                                        @php
                                        $total_sonchoi +=$rijab_fund->সঞ্চয়;
                                        @endphp  
                                        <td colspan="3">{{$rijab_fund->সঞ্চয়}}</td>
                                        @php
                                        $total_bises_sonchoi +=$rijab_fund->বিশেষ_সঞ্চয়_উত্তোলন;
                                        @endphp
                                        <td colspan="3">{{$rijab_fund->বিশেষ_সঞ্চয়_উত্তোলন}}</td>
                                        @php
                                        $total_rin +=$rijab_fund->ঋণ;
                                        @endphp
                                        <td colspan="3">{{$rijab_fund->ঋণ}}</td>
                                        <td colspan="3">
                                        <a href="/rijab-fund-uttolon/{{$rijab_fund->id}}" class="btn btn-info btn-sm">রিজার্ভ উত্তোলন</a>
										</td>
                               ...
                               <tfoot>
                                <tr role="row" class="odd text-center">
                                    ...
                                    <td colspan="4"></td>                                  
                                    <td colspan="3">{{$total_share}}</td>
                                    <td colspan="3">{{$total_sonchoi}}</td>
                                    <td colspan="3">{{$total_bises_sonchoi}}</td>
                                    <td colspan="3">{{$total_rin}}</td>
                                    <td colspan="3"></td>
...
<!-- Mirrored from html.phoenixcoded.net/nextro-able/bootstrap/default/layout-advance.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Dec 2020 23:44:59 GMT -->
</html>
