...
<li class="nav-item pcoded-hasmenu">
    <a href="/user-create-form" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">সদস্য তৈরি করুন</span></a>
...
<li class="nav-item pcoded-hasmenu">
    <a href="/anusangik-ai" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layers"></i></span><span class="pcoded-mtext"> আনুষঙ্গিক/রিজার্ভ আয়</span></a>
                            ...
                            <div class="table-responsive">
                                <table id="report-table" class="table table-bordered table-striped mb-0">
                                    ...
                                    @foreach ($user_info as $user_information)
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets') }}/images/avatar-2.jpg" class="img-fluid img-radius wid-40" alt="">
                                            </td>
                                            <td>{{$user_information->সদস্য_নাম_মি_মিসেস_মিস}}</td>
                                            <td>{{$user_information->সদস্য_বর্তমান_ঠিকানা}}</td>
                                            <td>{{$user_information->সদস্য_পিতা_স্বামীর_নাম}}</td>
                                            <td>{{$user_information->সদস্য_নং}}</td>

                                            <td>
                                                <a href="/rijab-fund/{{$user_information->id}}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i>&nbsp;রিজার্ভ ফান্ড </a>
                                                <button  class="btn btn-success btn-sm btn-round has-ripple" data-toggle="modal" data-target="#রশিদ{{$user_information->id}}"><i class="feather icon-plus"></i>রশিদ</button>
                                                <a href="/particuler-user-info/{{$user_information->id}}" class="btn btn-primary btn-sm"><i class="feather icon-edit"></i>&nbsp;ব্যক্তি খতিয়ান  </a>
                                            </td>
                                        </tr>

                                        <div class="modal fade" id="রশিদ{{$user_information->id}}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" style="color:#4680ff;" >শেয়ার ও সঞ্চয় আদায় রশিদ </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="/roshid-submit/{{$user_information->id}}" method="post" id="myform" enctype="multipart/form-data">
                                                         @csrf
                                                            <div class="row">
                                                                <!-- <div class="col-sm-6">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Name">রশিদ_নং   </label>
                                                                        <input type="text" name="রশিদ_নং" class="form-control" id="Name" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Name">শেয়ার </label>
                                                                        <input type="text" name="শেয়ার" class="form-control" id="Name" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group fill">
                                                                        <label class="floating-label" for="Email">সঞ্চয় </label>
                                                                        <input type="text" name="সঞ্চয়"  class="form-control" id="Email" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group fill">
                                                                        <label class="floating-label" for="Email">ঋণ ফেরৎ </label>
                                                                        <input type="text" name="ঋণ_ফেরৎ"   class="form-control" id="Email" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group fill">
                                                                        <label class="floating-label" for="Email">সুদ  </label>
                                                                        <input type="text" name="সুদ"  class="form-control" id="Email" placeholder="">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="ভর্তি_ফি"  class="form-control" id="Phone" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Phone">বিক্রয়</label>
                                                                        <input type="text" name="বিক্রয়"  class="form-control" id="Phone" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Phone">হিসাব খরচ</label>
                                                                        <input type="text" name="হিসাব_খরচ"  class="form-control" id="Phone" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Phone">বিশেষ সঞ্চয়</label>
                                                                        <input type="text" name="বিশেষ_সঞ্চয়"  class="form-control" id="Phone" placeholder="">
                                                                    </div>
                                                                </div>

                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Phone">পিএফ সঞ্চয় আদায়</label>
                                                                        <input type="text" name="জরিমানা"  class="form-control" id="Phone" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="floating-label" for="Phone">ত্যাগ ফি আদায়</label>
                                                                        <input type="text" name="জরিমানা"  class="form-control" id="Phone" placeholder="">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group fill">
                                                                        ...
                                                                        <input type="file" name="আদায়কারীর_স্বাক্ষর"  class="form-control" id="Icon" placeholder="sdf">
                                                                    </div>
                                                                </div>


                                                                <div class="col-sm-12">
                                                                     <input type="submit" name="register" class="btn btn-primary" value="জমা দিন">
