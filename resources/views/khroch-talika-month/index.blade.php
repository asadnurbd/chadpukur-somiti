        ...
        <div class="pcoded-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card-body">
                       <form action="/khroch-talika-month-data" method="post">
                        @csrf
                            <div class="row">
                                ...
                                <table id="report-table" class="table table-bordered table-striped mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>নাম</th>
                                            <th>শেয়ার ফেরত </th>
                                            <th>সঞ্চয় উত্তোলন </th>
                                            <th>বিশেষ সঞ্চয় উত্তোলন </th>
                                            <th>ঋণ প্রদান </th>
                                            <th>আনুষঙ্গিক_খরচের_নাম</th>
                                            <th>আনুষঙ্গিক খরচের পরিমাণ</th>
                                            <th>মোট খরচ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            <?php 
                                              $total_share_fherot=0;
                                              $total_shonchoi_uttolon=0;
                                              $total_bises_shonchoi_uttolon=0;
                                              $total_rinprodan=0;
                                              $total_sum=0;
                                     ...
                                     @foreach($abbhontorin_checks as $abbhontorin_check) 
                                        ...
                                        <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($abbhontorin_check->created_at)->format('d/m/y') }}</td>
                                                @foreach($users_info as $user_info) 
                                                @if($abbhontorin_check->হিসাব_নং == $user_info->সদস্য_নং)
                                                <td>{{$abbhontorin_check->হিসাব_নং}}</td>
                                                <td>{{$user_info->সদস্য_নাম_মি_মিসেস_মিস}}</td>
                                                @endif
                                                @endforeach

                                                @if($abbhontorin_check->হিসাব_নং == null)
                                                <td style="color:red;">Empty</td>
                                                <td>{{$abbhontorin_check->	অফিস_স্টাফ_নাম}}</td>
                                                @endif
                                                
                                                <td>{{$abbhontorin_check->শেয়ার_ফেরত}}</td>
                                                <td>{{$abbhontorin_check->সঞ্চয়_উত্তোলন}}</td>
                                                <td>{{$abbhontorin_check->বিশেষ_সঞ্চয়_উত্তোলন}}</td>
                                                <td>{{$abbhontorin_check->ঋণ_প্রদান}}</td>
                                              @foreach($khroch_types as $khroch_type)     
                                                @if($khroch_type->id == $abbhontorin_check->anusangik_id)
                                            
                                                 <td>{{$khroch_type->আনুষঙ্গিক_খরচের_নাম}}</td>
                                                 <td>{{$abbhontorin_check->আনুষঙ্গিক_খরচের_পরিমাণ}}</td>
                                            ...
                                            <?php 
                                                 $total_share_fherot+=$abbhontorin_check->শেয়ার_ফেরত;
                                                 $total_shonchoi_uttolon+=$abbhontorin_check->সঞ্চয়_উত্তোলন;
                                                 $total_bises_shonchoi_uttolon+=$abbhontorin_check->বিশেষ_সঞ্চয়_উত্তোলন;
                                                 $total_rinprodan+=$abbhontorin_check->ঋণ_প্রদান;
                                                 
                                                 $sum=$abbhontorin_check->শেয়ার_ফেরত+$abbhontorin_check->সঞ্চয়_উত্তোলন+$abbhontorin_check->বিশেষ_সঞ্চয়_উত্তোলন+$abbhontorin_check->ঋণ_প্রদান+$abbhontorin_check->আনুষঙ্গিক_খরচের_পরিমাণ;
                                    ...
                                    <tr>
                                        ...
                                        <th  colspan="1">
                                        @php echo $total_share_fherot; @endphp
                                        </th>
                                        <th  colspan="1">
                                        @php echo $total_shonchoi_uttolon; @endphp
                                        </th>
                                        <th  colspan="1">
                                        @php echo $total_bises_shonchoi_uttolon; @endphp
                                        </th>
                                        <th  colspan="1">
                                        @php echo $total_rinprodan; @endphp
                                        </th>
                                                ...
                                                @foreach($anusangik_khroch_amounts as $anusangik_khroch_amount) 
                                                 @foreach($khroch_types as $khroch_type) 
                                                   @if($khroch_type->id == $anusangik_khroch_amount->anusangik_id)
                                                 
                                                    {{$khroch_type->আনুষঙ্গিক_খরচের_নাম}} :====<br>
                                                ...
                                                @foreach($anusangik_khroch_amounts as $anusangik_khroch_amount) 
                                                 @foreach($khroch_types as $khroch_type) 
                                                   @if($khroch_type->id == $anusangik_khroch_amount->anusangik_id)
                                                     ...
                                                     {{$anusangik_khroch_amount->sum}} </br>
